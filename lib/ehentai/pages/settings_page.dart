      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            trailing: Observer(
              builder: (context) => Switch(
                value: ehentaiSettingsStore.autoUpdateTags,
                onChanged: (value) =>
                    ehentaiSettingsStore.setAutoUpdateTags(value),
              ),
            ),
          ),
          PopupMenuButton<String>(
              child: ListTile(
                ...
                subtitle: Observer(
                  builder: (context) =>
                      Text(switch (ehentaiSettingsStore.historyMode) {
          ...
          Observer(
            builder: (context) => ListTile(
              enabled: ehentaiSettingsStore.historyMode == HistoryMode.limited,
              ...
              subtitle: Observer(
                builder: (context) => Slider(
                  ...
                  max: 1000,
                  divisions: 9,
                  value: ehentaiSettingsStore.maxHistoryGalleries.toDouble(),
                  onChanged: (value) {
                    if (ehentaiSettingsStore.historyMode ==
                        HistoryMode.limited) {
                      ehentaiSettingsStore
              ...
              trailing: Observer(
                builder: (context) => Text(
                  '${ehentaiSettingsStore.maxHistoryGalleries}',
                  style: const TextStyle(fontSize: 16),
                ),
              ),
            ),
          ...
          PopupMenuButton<String>(
              child: ListTile(
                ...
                subtitle: Observer(
                  builder: (context) =>
                      Text(switch (ehentaiSettingsStore.showHistoryMode) {
          ...
          PopupMenuButton<String>(
              child: ListTile(
                ...
                subtitle: Observer(
                  builder: (context) =>
                      Text(switch (ehentaiSettingsStore.showFavoriteMode) {
